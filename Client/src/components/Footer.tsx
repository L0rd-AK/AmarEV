        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Bangladesh's leading EV charging network, powering sustainable transportation across the nation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link to="/map" className="hover:text-white transition-colors">Find Stations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Station Location</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2025 AmarEV. All rights reserved.
            </p>
